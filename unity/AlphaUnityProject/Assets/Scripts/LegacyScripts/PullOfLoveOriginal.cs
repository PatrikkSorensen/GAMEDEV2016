...
public class PullOfLoveOriginal : MonoBehaviour {
    GameObject B4, MiMi;
    ...
    void PullPlayer(GameObject character)
    {
        ...
        Vector3 forceVector = forceDirection.normalized * pullForce * 100;

        character.GetComponent<Rigidbody>().AddForce(forceVector);
